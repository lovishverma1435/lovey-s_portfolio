          ...
          <div className=" items-center lg:flex md:items-center h-screen relative pt-12 ">
            ...
            <div className=" flex flex-col gap-8 text-center sm:mx-auto max-w-[550px] w-full">
              <div className="flex flex-col gap-4 text-center ">
                <h1  data-aos="fade-down"  data-aos-delay="500" className='text-4xl sm:text-5xl md:text-6xl  lg:text-start font-bold'>Abo<span className='text-OrangeCustom'>ut Me...</span></h1>
                <h1 data-aos="fade-down"  data-aos-delay="400" className='text-lg sm:text-xl md:text-2xl leading-snug lg:text-start font-semibold'>Transforming ideas into digital <span className='text-2xl sm:text-3xl md:text-4xl text-OrangeCustom font-semibold'>experiences</span></h1>
              </div>
              <p data-aos="fade-down"  data-aos-delay="200" className="text-base sm:text-lg md:text-2xl leading-relaxed lg:text-start font-semibold">
                Hey, <span className='text-OrangeCustom text-xl sm:text-2xl lg:text-3xl font-extrabold'>I’m Lovey</span> 👋 A passionate <span className='text-OrangeCustom text-xl sm:text-2xl md:text-3xl font-extrabold'>Full-Stack Web Developer</span> driven by the love for creating responsive and impactful web applications that not only look beautiful but also provide seamless performance and meaningful solutions..
              </p>
              <div  className=" flex button gap-4 sm:gap-6 w-full pb-16 md:pb-0">
                <a data-aos="fade-up"  data-aos-delay="400"
                  ...
                  download={"cv"}
                  className='bg-OrangeCustom w-full py-3 px-14 rounded-xl flex justify-center items-center font-semibold text-lg gap-3 hover:scale-105 transition-transform duration-300 shadow-lg'
                >
                ...
                to={"/skills"}
                  className='bg-OrangeCustom w-full py-3 px-16 rounded-xl flex justify-center items-center font-semibold text-lg hover:scale-105 transition-transform duration-300 shadow-lg'
                >
                  <h1>Skills</h1>
                </Link>
              </div>
